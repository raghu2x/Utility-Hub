<script>
import ButtonInput from '../components/calculator/ButtonInput.vue'
import NavigatorMenu from '../components/calculator/NavigatorMenu.vue'
import CalculateDisplay from '../components/calculator/CalculateDisplay.vue'
export default {
